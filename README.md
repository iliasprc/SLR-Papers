...
2. **Sign Language Transformers: Joint End-to-end Sign Language Recognition and Translation** `ArXiv2020` [*paper*](https://arxiv.org/pdf/2003.13830.pdf) [*code*](https://github.com/neccam/slt)
3. **Word-level Deep Sign Language Recognition from Video: A New Large-scale Dataset and Methods Comparison** `WACV2020` [*paper*](https://arxiv.org/pdf/1910.11006.pdf) [*code*](https://github.com/dxli94/WLASL)
